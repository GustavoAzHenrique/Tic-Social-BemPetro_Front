...
export const CardHomeOportunidade = ({ pulicacao, id }) => {
  ...
  function CondicionalPlay() {
    if (pulicacao.status.status === "pendente") {
      setSection(1);
    } else {
      setSection(0);
    }
  ...
  function handleSubmitPlayStop() {
    api
      .put(
        `/oportunidade/${pulicacao.id}/pausar`,
        {},
  ...
  function handleSubmitDelete() {
    api
      .delete(`/oportunidade/${pulicacao.id}`, {
        headers: { Authorization: token },
      })
      .then((res) => {
        console.log(res);
...
border-color:  blue;
    ...
    `}
      ...
      <Card style={{ height: "350px" }}>
        <Card.Body>
          <Card.Title style={{ width: "15rem" }}>{pulicacao.titulo}</Card.Title>
          <Card.Subtitle
            className="card-subtitle-um mb-3 mt-3"
            style={{ width: "15rem", height: "140px", fontSize: "35px" }}
          >
            {pulicacao.cargo}
          </Card.Subtitle>
          ...
          <div className="botoes">
            ...
            >
              <Button
                style={btnCard}
                onClick={() => navigate(`/editarpublioportunidade/${id}`)}
              >
                <svg
