...
export const CardHomeRevisorEvento = ({ publicacao }) => {
  ...
  function CondicionalPlay() {
    if (publicacao.status.status === "pendente") {
      setSection(0);
    } else {
      setSection(1);
    }
...
border-color:  blue;
    ...
    `}
      ...
      <Card style={{ height: "350px" }}>
        <Card.Body>
          <Card.Title style={{ width: "15rem"  }}>{publicacao.nome}</Card.Title>

          <Card.Img style={{ width: "15rem", height: "140px" }} src={publicacao.imagem} />
          <Card.Subtitle
      ...
      >
        ...
        >
          <Modal.Title>{publicacao.nome}</Modal.Title>
        </div>
        <Modal.Body>
          <Form>
            <Form.Group controlId="exampleForm.ControlInput1">
              ...
              <Card.Img className="p-5" variant="top" src={publicacao.imagem} />
              <Card.Text className="p-3 d-flex justify-content-center align-items-center">
                data: {publicacao.dataEvento}
              </Card.Text>
              <Card.Text className="p-3 d-flex justify-content-center align-items-center">
