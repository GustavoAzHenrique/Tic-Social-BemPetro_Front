...
export const CardHomeRevisorOportunidade = ({ publicacao }) => {
  ...
  function handleSubmitAprovar() {
    api
      .put(
        `/oportunidade/${publicacao.id}/aprovar`,
        {},
  ...
  function handleSubmitReprovar() {
    api
      .put(
        `/oportunidade/${publicacao.id}/reprovar`,
        {},
        { headers: { Authorization: token } }
      )
      .then((res) => {
...
border-color:  blue;
    ...
    `}
      ...
      <Card style={{ height: "350px" }}>
        <Card.Body>
          <Card.Title style={{ width: "15rem" }}>
            {publicacao.titulo}
          </Card.Title>

          <Card.Title style={{ width: "15rem", height: "140px", alignItems:"center"}}>
            {publicacao.cargo}
          </Card.Title>

          {/* <Card.Img
            style={{ width: "15rem", height: "140px" }}
            src={publicacao.imagemPrimaria}
          /> */}
          <Card.Subtitle
      ...
      >
        ...
        >
          <Modal.Title>{publicacao.titulo}</Modal.Title>
        </div>
        <Modal.Body>
          <Form>
            <Form.Group controlId="exampleForm.ControlInput1">
              ...
              <Card.Text className="p-3 d-flex justify-content-center align-items-center">
                data noticia: {publicacao.dataCadastro}
              </Card.Text>
            </Form.Group>
          </Form>
        </Modal.Body>
